...
import com.orco.spark.deploy.ExecutorState.ExecutorState
import com.orco.spark.deploy.master.DriverState.DriverState
import com.orco.spark.rpc.{RpcAddress, RpcEndpointRef}
...
//  case class Heartbeat(workerId: String, worker: RpcEndpointRef) extends DeployMessage
  ...
  case object ReregisterToMaster // used when a masterStandby attempts to reconnect to a master
